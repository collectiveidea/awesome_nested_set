...
This has been fixed up for use with Rails 3.x for use with Arel and fixed Deprecation warnings

== Installation

Install as a plugin:

  rails plugin install git://github.com/tommg/awesome_nested_set.git
